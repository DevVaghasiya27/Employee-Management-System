...
const getEmployees = async (req, res) => {
    try{
        ...
        return res.status(500).json({success: false, error: "get employees server errror"})
    }
}
...
//     } 
//     catch(error){
//         return res.status(500).json({success: false, error: "Delete Employee server errror"})
//     }
// }
...
const fetchEmployeesByDepId = async (req, res) => {
    ...
    try{
        ...
        return res.status(500).json({success: false, error: "get employeesbyDepId server errror"})
    }
}

export {addEmployee, getEmployees, getEmployee, upload, updateEmployee, fetchEmployeesByDepId}